...
export const Layout: React.FC<LayoutProps> = ({ children, activeTab, setActiveTab, merchantName, onLogout, userRole }) => {
  const [isSidebarOpen, setIsSidebarOpen] = useState(false);

  const allNavItems = [
    {
      id: 'members', label: 'Membros', roles: ['admin', 'manager'], icon: (
    ...
    {
      id: 'dashboard', label: 'Gerar Carnê', roles: ['admin', 'manager'], icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
      id: 'management', label: 'Gerenciamento', roles: ['admin', 'manager'], icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
      id: 'reports', label: 'Relatórios', roles: ['admin', 'viewer'], icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
